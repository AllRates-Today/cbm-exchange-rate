'use strict';
// Central Bank of Myanmar exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/cbm';
...
/** Latest rate for one pair, e.g. getRate('USD', 'MMK', { apiKey }). */
